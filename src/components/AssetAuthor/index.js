...
function Item(props) {
  ...
  const getAvatars = async () => {
    try {
      if (owner) {
        const owner_data = await Get_Profile_By_AccountId(owner,'');
      ...
      <li>
        ...
        <div className="asset__author asset__author--verified">
          <img
            ...
            alt=""
          />
          <Link to={`/creator-public/${creator}`}>
            {creatorData?.firstName ? creatorData?.firstName : creator} {creatorData?.lastName}
          </Link>
        </div>
      </li>
      <li>
        ...
        <div className="asset__author ">
          ...
          >
            {ownerData?.firstName ? ownerData?.firstName : owner} {ownerData?.lastName}
          </Link>
        </div>
      </li>
    </ul>
