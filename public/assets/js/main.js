...
$(document).ready(function () {
  ...
  $(document).on("click", ".praktyka h4", function () {
    $(this).parent().find('.praktyka-content').slideToggle();
    $(this).parent().toggleClass('headerActive');
  })
  ...
  $(function () {
    ...
    const lastTab = window.location?.pathname.slice(1)
    if (lastTab) {
      $(".header__nav-link").removeClass("headerActive");
      $(`.${lastTab}`).toggleClass('headerActive')
    
    }
    else {
      $(`._home`).toggleClass('headerActive')
